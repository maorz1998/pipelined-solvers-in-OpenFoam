...
namespace Foam
{
    defineTypeNameAndDebug(NBPCG, 0);

    lduMatrix::solver::addsymMatrixConstructorToTable<NBPCG>
        addPBiCGStabSymMatrixConstructorToTable_;

    lduMatrix::solver::addasymMatrixConstructorToTable<NBPCG>
...
Foam::solverPerformance Foam::NBPCG::solve
(
    scalarField& psi,
